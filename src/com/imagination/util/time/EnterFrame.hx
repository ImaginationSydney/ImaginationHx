...
import com.imagination.util.sys.SysTools;
...
class EnterFrame
{
	...
	static private function setupListener():Void
	{
			...
			#end
		#elseif cpp
			com.imagination.cpp.sys.FrameThread.instance.addFrame(onEnterFrame);
		#end
		_lastT = getTimer();
	}
	...
	inline static public function getFPS():Float {
		...
		#else
			return com.imagination.cpp.sys.FrameThread.instance.fps;
		#end
	}
